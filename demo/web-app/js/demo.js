...
const app = new Vue({
    ...
    data() {
        return {
            input: '',
            countries: Object.keys(iban.availableCountries()),
    ...
    computed: {
        ...
        couldBeIBAN() {
            ...
            const countryCode = this.input.substring(0, 2);
            return this.input.length > 2 && !!availableCountries[countryCode.toUpperCase()];
        },
        couldBeBBAN() {
