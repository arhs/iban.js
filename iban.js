 ...
 * @returns {string}
 */
export const electronicFormat = function(iban){
 ...
 */
export const isValid = function(iban){
    if (!isString(iban)){
        return false;
    }
 ...
 * @returns {string|*}
 */
export const toBBAN = function(iban, separator){
 ...
 * @returns {string} the IBAN
 */
export const fromBBAN = function(countryCode, bban){
 ...
 */
export const isValidBBAN = function(countryCode, bban){
    if (!isString(bban)){
        return false;
    }
    var countryStructure = countries[countryCode];
 ...
 * @returns {string}
 */
export const printFormat = function(iban, separator){
    if (typeof separator == 'undefined'){
        separator = ' ';
    }
